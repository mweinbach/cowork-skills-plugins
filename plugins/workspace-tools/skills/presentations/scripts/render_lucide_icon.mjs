...
const requireCandidateBases = [
  ...
  path.join(defaultRuntimeNodeModules(), "__cowork_runtime_require__.mjs"),
...
function requireAvailable(moduleName) {
  ...
  throw new Error(`Cannot resolve required module '${moduleName}' from the bundled Cowork runtime`);
}
