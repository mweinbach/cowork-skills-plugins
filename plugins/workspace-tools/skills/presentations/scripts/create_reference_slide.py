...
RULES = """
Prepare a Cowork imagegen prompt for a professional PPTX reference slide.
...
def main() -> int:
    ...
    from cowork_generate_image import main as write_imagegen_prompt

    sys.argv = [
        str(Path(__file__).with_name("cowork_generate_image.py")),
        prompt,
        "--quality",
        "medium",
        "--force",
